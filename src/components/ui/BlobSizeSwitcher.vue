<template>
  <div class="blob-size-switcher">
    <span class="information">Taille du message</span>
    <div class="blob-size-box">
      <svg @click="setFontSize('small')" fill="currentColor" class="action icon small" :class="{active: chatState.messageSize === 'small'}" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<path d="M364.3,207.5c-0.7-4.2-2-8.3-3.3-12.4c-2.3-7.1-5.9-15-9.3-21.7c-1-2.1-2.2-4.1-3.5-6l0,0c-3.2-4.8-5.3-10.2-6.2-15.8
	...
	C368.8,229.4,365.8,216.8,364.3,207.5z"/>
        ...
        <svg @click="setFontSize('medium')" fill="currentColor" class="action icon medium" :class="{active: chatState.messageSize === 'medium'}" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 400 400" style="enable-background:new 0 0 400 400;" xml:space="preserve">
<path d="M364.3,207.5c-0.7-4.2-2-8.3-3.3-12.4c-2.3-7.1-5.9-15-9.3-21.7c-1-2.1-2.2-4.1-3.5-6l0,0c-3.2-4.8-5.3-10.2-6.2-15.8
	c-0.2-1.4-0.5-2.8-0.7-4.1c-0.6-3.5-2-9-3.2-12.3c-2.6-7.3-5.8-14.4-9.2-21.3c-1.6-3.2-4.7-8.1-6.7-11.1
	c-6.2-9.3-13.4-17.8-20.5-26.2c-3.8-4.5-7.9-8.8-12.3-12.7c-15.1-13.6-28.8-21.3-48.6-28.2c-6-2.1-10.3-2.7-17-3.6
	...
	C368.8,229.4,365.8,216.8,364.3,207.5z"/>
        ...
        <svg @click="setFontSize('large')" fill="currentColor" class="action icon large" :class="{active: chatState.messageSize === 'large'}" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 400 400" style="enable-background:new 0 0 400 400;" xml:space="preserve">
<path d="M364.3,207.5c-0.7-4.2-2-8.3-3.3-12.4c-2.3-7.1-5.9-15-9.3-21.7c-1-2.1-2.2-4.1-3.5-6l0,0c-3.2-4.8-5.3-10.2-6.2-15.8
	c-0.2-1.4-0.5-2.8-0.7-4.1c-0.6-3.5-2-9-3.2-12.3c-2.6-7.3-5.8-14.4-9.2-21.3c-1.6-3.2-4.7-8.1-6.7-11.1
	c-6.2-9.3-13.4-17.8-20.5-26.2c-3.8-4.5-7.9-8.8-12.3-12.7c-15.1-13.6-28.8-21.3-48.6-28.2c-6-2.1-10.3-2.7-17-3.6
...
<style lang="scss">
  ...
  body.theme-light {
    ...
    & .blob-size-switcher .blob-size-box {
